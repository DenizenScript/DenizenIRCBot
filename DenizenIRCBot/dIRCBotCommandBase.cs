    ...
    public partial class dIRCBot
    {
        public void TryCommand(CommandDetails command)
        {
            switch (command.Name.ToLower())
            {
                ...
                case "teamspeak":
                case "teamspeak3":
                    if (Configuration.ReadString("dircbot.irc.channels." + command.Channel.Name.Replace("#", "") + ".denizen_meta", "false").StartsWith("t"))
                    {
                ...
                case "iss":
                    {
                        ...
                        if (Configuration.ReadString("dircbot.irc.channels." + command.Channel.Name.Replace("#", "") + ".citizens_meta", "false").StartsWith("t"))
                        {
                ...
                case "wiki":
                    ...
                    break;
                case "ipstalk":
                    if (command.User.OP && Configuration.ReadString("dircbot.irc.channels." + command.Channel.Name.Replace("#", "") + ".admin", "false").StartsWith("t"))
                    {
                ...
                case "log":
                case "logs":
                    if (Configuration.ReadString("dircbot.irc.channels." + command.Channel.Name.Replace("#", "") + ".has_log_page", "false").StartsWith("t"))
                    {
                ...
                case "readlogs":
                    if (!command.User.OP
                        || !Configuration.ReadString("dircbot.irc.channels." + command.Channel.Name.Replace("#", "") + ".admin", "false").StartsWith("t"))
                    {
